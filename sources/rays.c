...
{
	test->game->txt.no.scale = (fmod(test->xy_pxel, 64) / 64)
		* test->game->txt.no.width;
	test->game->txt.ea.scale = (fmod(test->yx_pxel, 64) / 64)
		* test->game->txt.ea.width;
	test->game->txt.so.scale = (fmod(test->xy_pxel, 64) / 64)
		* test->game->txt.so.width;
	test->game->txt.we.scale = (fmod(test->yx_pxel, 64) / 64)
		* test->game->txt.we.width;
}
